...
- Fixed stdio MCP servers that die before completing the handshake reporting an opaque connection error; the failure now quotes the server's own stderr tail ([#11923](https://github.com/can1357/oh-my-pi/issues/11923)).
